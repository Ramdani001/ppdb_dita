<section class="bg-light p-5" style="width: 100%; height: 100%; padding-top: 100px;">
    <h1 class="mt-5 text-center pb-5">Tenaga Pendidik</h1>
    ...
    <div class="d-flex flex-wrap justify-content-between gap-5 flex-wrap">
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body text-center">
                ...
                <div class="card-text text-secondary">Nip : xxxxxxxxxxxxxxxx</div>
                <div class="card-text text-secondary">Tahun Masuk : 2016</div>
            </div>
        </div>
        <!-- Card -->
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body text-center">
                ...
                <div class="card-text text-secondary">Nip : xxxxxxxxxxxxxxxx</div>
                <div class="card-text text-secondary">Tahun Masuk : 2018</div>
            </div>
        </div>
        ...
        <div class="card" style="width: 18rem;">
            ...
            <div class="card-body text-center">
                ...
                <div class="card-text text-secondary">Nip : xxxxxxxxxxxxxxxx</div>
                <div class="card-text text-secondary">Tahun Masuk : 2021</div>
            </div>
        </div>
