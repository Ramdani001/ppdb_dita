  ...
  <div class="ps-5">
    ...
    <fieldset class="d-flex flex-wrap justify-content-evenly gap-3">
        ...
        <div class="card eks shadow-md" style="width: 25rem; cursor: pointer;">
          <img src="public/assets/img/padus.jpg" class="card-img-top" alt="...">
          <div id="cardBody-eks" class="card-body position-absolute bottom-0">
        ...
        <!-- Card --> 
        <div class="card eks shadow-md" style="width: 25rem; cursor: pointer;">
          <img src="public/assets/img/pmr.png" class="card-img-top" alt="...">
          <div id="cardBody-eks" class="card-body position-absolute bottom-0">
        ...
        <!-- Card -->
        <div class="card eks shadow-md" style="width: 25rem; cursor: pointer;">
          <img src="public/assets/img/irma.jpg" class="card-img-top" alt="...">
          <div id="cardBody-eks" class="card-body position-absolute bottom-0">
